...
BuildRequires:  %{?scl_prefix}mvn(isorelax:isorelax)
...
BuildRequires:  %{?scl_prefix}mvn(relaxngDatatype:relaxngDatatype)
...
%mvn_package ":%{pkg_name}{,-testharness}::{}:" __noinstall
...
# Manuals
install -d -m 755 %{buildroot}%{_docdir}/%{pkg_name}/msv
install -m 644 msv/doc/*.html     %{buildroot}%{_docdir}/%{pkg_name}/msv
install -m 644 msv/doc/*.gif      %{buildroot}%{_docdir}/%{pkg_name}/msv
install -m 644 msv/doc/README.txt %{buildroot}%{_docdir}/%{pkg_name}/msv

install -d -m 755 %{buildroot}%{_docdir}/%{pkg_name}/rngconverter
install -m 644 rngconverter/README.txt %{buildroot}%{_docdir}/%{pkg_name}/rngconverter

install -d -m 755 %{buildroot}%{_docdir}/%{pkg_name}/generator
install -m 644 generator/*.html     %{buildroot}%{_docdir}/%{pkg_name}/generator
install -m 644 generator/README.txt %{buildroot}%{_docdir}/%{pkg_name}/generator

install -d -m 755 %{buildroot}%{_docdir}/%{pkg_name}/xsdlib
install -m 644 xsdlib/*.html     %{buildroot}%{_docdir}/%{pkg_name}/xsdlib
install -m 644 xsdlib/README.txt %{buildroot}%{_docdir}/%{pkg_name}/xsdlib

# Examples
install -d -m 755 %{buildroot}%{_datadir}/%{pkg_name}/msv
cp -pr msv/examples/* %{buildroot}%{_datadir}/%{pkg_name}/msv
install -d -m 755 %{buildroot}%{_datadir}/%{pkg_name}/xsdlib
cp -pr xsdlib/examples/* %{buildroot}%{_datadir}/%{pkg_name}/xsdlib
